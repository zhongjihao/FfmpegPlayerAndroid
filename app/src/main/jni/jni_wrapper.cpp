//
// Created by zhongjihao on 21-1-4.
//
...
jstring Jni_urlProtocolInfo(JNIEnv *env, jclass jcls) {
    char info[40000] = {0};
    av_register_all();
...
jstring Jni_avFormatInfo(JNIEnv *env, jclass jcls) {
    char info[40000] = {0};
...
jstring Jni_avCodecInfo(JNIEnv *env, jclass jcls) {
    char info[40000] = {0};
...
jstring Jni_avFilterInfo(JNIEnv *env, jclass jcls) {
    char info[40000] = {0};
...
void Jni_playVideo(JNIEnv *env, jclass jcls, jstring videoPath_, jobject surface) {
...
static jint registerNativeMethods(JNIEnv *env, const char *className, JNINativeMethod *gMethods,
                                  int numMethods) {
    jclass clazz;
...
static JNINativeMethod gMethods[] = {
        {"urlProtocolInfo", "()Ljava/lang/String;",                       (void *) Jni_urlProtocolInfo},
        {"avFormatInfo",    "()Ljava/lang/String;",                       (void *) Jni_avFormatInfo},
        {"avCodecInfo",     "()Ljava/lang/String;",                       (void *) Jni_avCodecInfo},
        {"avFilterInfo",    "()Ljava/lang/String;",                       (void *) Jni_avFilterInfo},
        {"playVideo",       "(Ljava/lang/String;Landroid/view/Surface;)V", (void *) Jni_playVideo},
};

//定义java中类全名
static const char *classPathName = "com/android/ffmpegplayer/Ffplayer";
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    env = uenv.env;
    //注册java函数
    if (registerNatives(env, classPathName, gMethods, sizeof(gMethods) / sizeof(gMethods[0])) !=
        JNI_TRUE) {
        return -1;
    }
